...
var FlyweightFactory = function(){
	...
	var get = function(project, priority, user, completed){
		if(!flyweight[project + priority + user + completed]){
...
var innitialMemory = process.memoryUsage().heapUsed;
...
console.log('used memory ' + (afterMemory - innitialMemory) / 100000);
console.log("tasks: " + tasks.getCount());
console.log("flyweights: " + flywightFactory.getCount());
